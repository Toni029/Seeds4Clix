export default function AIOperatingSystemPage() {
  return (
    <section className="mx-auto flex min-h-[60vh] max-w-6xl flex-col justify-center gap-6 px-6 py-24">
      ...
      <h1 className="text-5xl font-semibold tracking-tight text-balance">AI Operating System</h1>
      <p className="max-w-2xl text-lg leading-8 text-muted-foreground">
        Create the operating rhythm, workflows, and systems that make AI useful every day.
      </p>
    </section>
  );
}
